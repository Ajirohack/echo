...
import { Card, Select, Button, Row, Col, Alert, Progress, Typography, Space, Tooltip, message } from 'antd';
import { AudioOutlined, ReloadOutlined, InfoCircleOutlined, CheckCircleFilled, CloseCircleFilled } from '@ant-design/icons';
...
const AudioDeviceSelector = () => {
  ...
  useEffect(() => {
    ...
    const levelInterval = setInterval(() => {
      if (isCapturing) {
        audioService.getAudioLevels().then(levels => {
  ...
  const renderTestStatus = (type) => {
    ...
    const statusMap = {
      ...
      success: <span style={{ color: '#52c41a' }}><CheckCircleFilled /> Success</span>,
      error: <span style={{ color: '#ff4d4f' }}><CloseCircleFilled /> Failed</span>
    };
    ...
    <div className="audio-device-selector">
      <Card 
        title={
          <Space>
            <AudioOutlined />
            <span>Audio Device Configuration</span>
          </Space>
        }
        extra={
          <Button 
      ...
      >
        ...
        <Row gutter={[16, 24]}>
            ...
            <div className="device-selector">
              ...
              <div className="audio-level" style={{ marginTop: 8 }}>
                <Progress 
                  ...
                  strokeColor={isCapturing ? '#1890ff' : '#52c41a'}
                />
          ...
          <Col xs={24} md={8}>
            <div className="device-selector">
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                <Text strong>Output Device</Text>
                <Button 
                  type="link" 
                  size="small" 
            ...
            <div className="device-selector">
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <Text strong style={{ marginRight: 8 }}>Virtual Device</Text>
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        if (os.includes('win')) {
                          ...
                          url = 'https://www.freedesktop.org/wiki/Software/PulseAudio/Documentation/User/Modules/#module-null-sink';
                        }
