/**
 * Auto-updater module for Universal Translator
...
class AutoUpdater {
    ...
    showUpdateAvailableDialog(info) {
        const options = {
            ...
            message: `A new version of Universal Translator is available!`,
    ...
    showNoUpdateDialog() {
        const options = {
            ...
            detail: `Universal Translator ${app.getVersion()} is the latest version available.`,
            buttons: ['OK'],
            defaultId: 0
        };
