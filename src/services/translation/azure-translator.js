...
class AzureTranslator extends EventEmitter {
  ...
  async translateText(text, fromLanguage, toLanguage, options = {}) {
    ...
    // Make request
    try {
      const response = await axios.post(`${this.config.endpoint}/translate`, [{ text: text }], {
        params: params,
        headers: {
  ...
  async detectLanguage(text) {
    try {
      ...
      const response = await axios.post(`${this.config.endpoint}/detect`, [{ text: text }], {
  ...
  async translateBatch(texts, fromLanguage, toLanguage, options = {}) {
    try {
      ...
      // Make request
      const response = await axios.post(`${this.config.endpoint}/translate`, requestBody, {
        params: params,
        headers: {
          'Ocp-Apim-Subscription-Key': this.config.apiKey,
          'Ocp-Apim-Subscription-Region': this.config.region,
