    ...
    constructor(config = {}) {
        ...
        this.services = {
            elevenlabs: this.config.providers.elevenlabs.enabled ?
                new ElevenLabsService(this.config.providers.elevenlabs) : null,
            azure: this.config.providers.azure.enabled ?
                new AzureTTS(this.config.providers.azure) : null,
            google: this.config.providers.google.enabled ?
                new GoogleTTS(this.config.providers.google) : null
        };
