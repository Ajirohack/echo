...
describe('Translation Service Integration', () => {
  ...
  test('should translate text through the complete pipeline', async () => {
    ...
    expect(mockCacheTranslation).toHaveBeenCalledWith(
      testText, 'en', 'es', expectedTranslation, undefined
    );
  });
  ...
  test('should handle translation errors gracefully', async () => {
    ...
    await expect(translationManager.translateText(testText, 'en', 'es'))
      .rejects
  ...
  test('should handle concurrent translation requests', async () => {
    ...
    expect(mockCacheTranslation).toHaveBeenCalledWith(testText1, 'en', 'es', expectedTranslation1, undefined);
    expect(mockCacheTranslation).toHaveBeenCalledWith(testText2, 'en', 'es', expectedTranslation2, undefined);
  });
  ...
  test('should respect the cache TTL', async () => {
    ...
    expect(mockCacheTranslation).toHaveBeenCalledWith(
      testText, 'en', 'es', cachedTranslation, ttl
    );
  });
});
