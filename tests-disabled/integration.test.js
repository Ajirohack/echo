...
describe('Translation Pipeline Integration Tests', function() {
  ...
  it('should handle service failure gracefully', async function() {
    ...
    await expect(pipeline.processAudio(audioBuffer, 'en', 'es'))
      .to.be.rejectedWith(Error, 'Translation service unavailable');
  ...
  describe('Service Failover', function() {
    it('should handle service failure gracefully', async function() {
      ...
      await expect(pipeline.processAudio(audioBuffer, 'en', 'es'))
        .to.be.rejectedWith(Error, 'Service unavailable');
  ...
  describe('Error Handling', function() {
    it('should handle API errors gracefully', async function() {
      ...
      await expect(pipeline.processAudio(new Float32Array(), 'en', 'fr'))
